  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="col-md-12 col-sm-12 text-center">
        <button class="btn btn-primary btn-lg" style="margin: 10px; border: 2px solid red" @click="onAnswer(btnData[1].correct)">{{ btnData[1].answer }}</button>
      </div>
      <div class="col-md-12 col-sm-6 text-center">
        <button class="btn btn-primary btn-lg" style="margin: 10px; border: 2px solid red" @click="onAnswer(btnData[2].correct)">{{ btnData[2].answer }}</button>
      </div>
      <div class="col-md-12 col-sm-6 text-center">
        <button class="btn btn-primary btn-lg" style="margin: 10px; border: 2px solid red" @click="onAnswer(btnData[3].correct)">{{ btnData[3].answer }}</button>
      </div>
    </div>
  </div>
</template>
